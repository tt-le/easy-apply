...
## Planning Meetings (SR(N-1).md, sprintN.md) (max 2 marks)
  ...
  Planning Meetings Total Mark: _ 4/ 4
...
## User Stories (Tracked in Jira) (max 10 marks) 
  ...
  User Stories Total Mark: __10 / 10
...
## Tracking on Jira  (max 24 marks) 
  ...
  - Did you start all stories for the sprint? (max 2 marks)
    ...
    Your Mark: _1  subtasks for TEAM-5 not started 
  ...
  - Is the git commit message clear? (max 2 marks)
    ...
    Your Mark: _1 commit msg like 'fix bug' is not clear sha 21bbca08f7726675f83c869f8bd77f0759cd01f4
...
## Documentation (max 1 mark)
  ...
  Your Mark: __0 / 1 no documentation file in repo
